...
title: "US NLM:Pubmed: trial classification"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://courses.edx.org/c4x/MITx/15.071x_2/asset/clinical_trial.csv  
    New:        <newdt_url>  
Time period: 

```{r set_global_options_wd, echo=FALSE}
setwd("~/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Assignments/HW5_USNLM_Pubmed")
```
...
```{r fit.models_0.5, cache=FALSE, fig.height=10, fig.width=15}
